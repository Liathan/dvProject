...
y = d3.scaleLinear().domain([0, 26000]).range([0, height_stacked])
var pippo
d3.csv("data/THS_T_nace.csv").then(function (data) {
    pippo = data
    ...
    svg_stacked.selectAll("path").data(coso).join("path").attr("d", area).style("fill", "red")
